            ...
            <div class="row logo_container">
                <div class="col-md-2">
                    <div class="site_logo center-block">
                        <a href="/">
                            <img alt="Property Logo" src="//codecloud.cdn.speedyrails.net/sites/5afb34e36e6f646e4a5d0000/image/png/1521831709000/cambridgelogo@3x.png">
                        </a>
                    </div>
                    ...
                    <div class="header_social_container hidden-sm hidden-xs">
                        ...
                        <div class="header_newsletter">
                            <div class="header_newsletter_container">
                                <label class="accessibility" for="header_newsletter"></label>
